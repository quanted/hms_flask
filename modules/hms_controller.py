        ...
        if task_id is not None:
            ...
            if task.status == "SUCCESS":
                ...
                if posts_data is None:
                    data = None
                    logging.info("No data for mongodb: hms, posts: data, id: {}".format(task_id))
                else:
                    logging.info(f"Data found. Loading data from mongodb for job: {task_id}")
                ...
                try:
                    ...
                    if data is not None:
                        ...
                        status = task.status
                    logging.info(f"Data found, status is: {status}. Loading data from mongodb for job: {task_id}")
